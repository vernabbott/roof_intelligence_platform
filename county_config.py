...
COUNTY_PROFILES: dict[str, CountyProfile] = {
    ...
    "boulder": CountyProfile(
        ...
        assessor_url=None,
        default_zip_codes="",
        default_output_name="data/CO/Boulder/parcels/boulder_buildings_with_parcels.csv",
        default_parcel_cache_name="data/CO/Boulder/parcels/boulder_parcel_data.csv",
    ...
    "broomfield": CountyProfile(
        ...
        assessor_url=None,
        default_zip_codes="",
        default_output_name="data/CO/Broomfield/parcels/broomfield_buildings_with_parcels.csv",
        default_parcel_cache_name="data/CO/Broomfield/parcels/broomfield_parcel_data.csv",
        imagery_sources=WORLD_IMAGERY_SOURCES,
        building_source="postgis",
        building_crs=4326,
    ),
    "clear_creek": CountyProfile(
        ...
        assessor_url=None,
        default_zip_codes="",
        default_output_name="data/CO/ClearCreek/parcels/clear_creek_buildings_with_parcels.csv",
        default_parcel_cache_name="data/CO/ClearCreek/parcels/clear_creek_parcel_data.csv",
        imagery_sources=WORLD_IMAGERY_SOURCES,
        building_source="postgis",
        building_crs=4326,
    ),
    "douglas": CountyProfile(
        ...
        assessor_url=None,
        default_zip_codes="",
        default_output_name="data/CO/Douglas/parcels/douglas_buildings_with_parcels.csv",
        default_parcel_cache_name="data/CO/Douglas/parcels/douglas_parcel_data.csv",
        imagery_sources=WORLD_IMAGERY_SOURCES,
        building_source="postgis",
        building_crs=4326,
    ),
    "larimer": CountyProfile(
        ...
        assessor_url=None,
        default_zip_codes="",
        default_output_name="data/CO/Larimer/parcels/larimer_buildings_with_parcels.csv",
        default_parcel_cache_name="data/CO/Larimer/parcels/larimer_parcel_data.csv",
    ...
    "weld": CountyProfile(
        ...
        assessor_url=None,
        default_zip_codes="",
        default_output_name="data/CO/Weld/parcels/weld_buildings_with_parcels.csv",
        default_parcel_cache_name="data/CO/Weld/parcels/weld_parcel_data.csv",
        imagery_sources=WORLD_IMAGERY_SOURCES,
        building_source="postgis",
        building_crs=4326,
    ),
