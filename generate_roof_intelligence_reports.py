...
def reference_analysis_prompt(
    ...
    return (
        ...
        "imagery, but confidence must remain 60 or below when rib height and profile are unresolved. Dense straight lines "
        "that stay uniformly spaced across broad rigid roof planes and align with visible slope or drainage direction "
        "strongly favor metal over modified bitumen, even when the finish is gray, weathered, patched, or partially coated. "
        ...
        "asphaltic substrate. For a dark membrane zone "
